  ...
  stages {
    stage('Checkout Source') {
        steps {
            ...
            git credentialsId: 'da01f3e1-20fb-4222-94cf-b3f1927cc162', url: "https://gogs-gogs-demo0304-gogs.apps.dennis-cluster1.vb3x.p1.openshiftapps.com/CICDLabs/openshift-tasks-private.git"
    ...
    stage('Code Analysis') {
      steps {
            ...
            sh "${mvnCmd} sonar:sonar -Dsonar.host.url=http://sonarqube-${prefix}-sonarqube.apps.dennis-cluster1.vb3x.p1.openshiftapps.com/ -Dsonar.projectName=${JOB_BASE_NAME} -Dsonar.projectVersion=${devTag}"
            }
      }
    }
